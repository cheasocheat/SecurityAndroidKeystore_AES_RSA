...
import com.asvacode.securityandroidkeystore_aes_rsa.PreferenceHelper.edit
...
object PreferenceHelper {
    ...
    fun instance(context: Context): SharedPreferences = context.getSharedPreferences("pref_collection_go", Context.MODE_PRIVATE)
